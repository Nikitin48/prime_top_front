          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (productColorCode != null || coatingTypeName != null) ...[
                  const SizedBox(height: 8),
                  Wrap(
                    spacing: 16,
                    runSpacing: 8,
                    children: [
                      if (productColorCode != null && productColorCode! > 0)
                        _buildInfoChip(
                          context,
                          'RAL $productColorCode',
                          isDark,
                        ),
                      if (coatingTypeName != null && coatingTypeName!.isNotEmpty)
                        _buildInfoChip(
                          context,
                          coatingTypeName!,
                          isDark,
